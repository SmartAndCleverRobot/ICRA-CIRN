...
from datasets.data import get_data,get_seen_data,get_unseen_data
...
def nonadaptivea3c_train_seen(
    ...
    glove = Glove(args.glove_file)
     #mark2 这个possible_targets这个变量没有用
    ...
    while not end_flag.value:
        ...
        player_start_time = time.time()
        # print(player.episode.target_object)
