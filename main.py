...
from main_eval import main_eval,main_eval_unseen,main_eval_seen,full_main_eval_unseen, full_main_eval_seen
...
def main():
    ...
    if args.eval:
        if args.zsd:
            ...
            full_main_eval_unseen(args, create_shared_model, init_agent)
            # main_eval_unseen(args, create_shared_model, init_agent)
            print("#######################################################")
            print("Evaluate Seen Classes !")
            args.split = args.seen_split
            args.scene_types = args.seen_scene_types
            full_main_eval_seen(args, create_shared_model, init_agent)
    ...
    # nonadaptivea3c_train_seen(0, args, create_shared_model, shared_model, init_agent, optimizer, train_res_queue, end_flag)
    # shared_model = None
