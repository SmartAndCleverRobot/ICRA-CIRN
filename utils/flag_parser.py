...
def parse_arguments():
    ...
    parser.add_argument(
        "--save-model-dir",
        default="/home/Newdisk/lixinting/zero-shot-trained-model/",
        metavar="SMD",
    ...
    parser.add_argument(
        "--offline_data_dir",
        type=str,
        default="/home/Newdisk/lixinting/zero-shot-data/data/thor_v1_offline_data", #thor_offline_data
        help="where dataset is stored.",
    )
    parser.add_argument(
        "--glove_dir",
        type=str,
        default="/home/Newdisk/lixinting/zero-shot-data/data/thor_glove/glove_thorv1_300.hdf5",
