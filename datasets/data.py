...
def name_to_num(args,name):
    return args.scene_types.index(name)

def num_to_name(num):
    return ["kitchen", "", "living_room", "bedroom", "bathroom"][int(num / 100)]


def get_data(scene_types, scenes): # 这个函数是用来
...
def get_seen_data(scene_types, scenes, split):
    ...
    if split == "18/4":
        ...
        possible_targets = BEDROOM_OBJECT_CLASS_LIST
        targets = [
        KITCHEN_OBJECT_CLASS_LIST,
        LIVING_ROOM_OBJECT_CLASS_LIST,
        BEDROOM_OBJECT_CLASS_LIST,
        ...
        print("Class Split:" + split + " all classes:" + str(len(possible_targets)))

    elif split == "kitchen":
        possible_targets = KITCHEN_OBJECT_CLASS_LIST
        targets = [
        KITCHEN_OBJECT_CLASS_LIST,
        LIVING_ROOM_OBJECT_CLASS_LIST,
        BEDROOM_OBJECT_CLASS_LIST,
    ...
    elif split == 'living_room':
        possible_targets = LIVING_ROOM_OBJECT_CLASS_LIST
        targets = [
        KITCHEN_OBJECT_CLASS_LIST,
        LIVING_ROOM_OBJECT_CLASS_LIST,
        BEDROOM_OBJECT_CLASS_LIST,
        ...
        possible_targets = BATHROOM_OBJECT_CLASS_LIST
        targets = [
        KITCHEN_OBJECT_CLASS_LIST,
        LIVING_ROOM_OBJECT_CLASS_LIST,
        BEDROOM_OBJECT_CLASS_LIST,
