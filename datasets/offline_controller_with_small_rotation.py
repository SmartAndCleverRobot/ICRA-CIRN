...
class OfflineControllerWithSmallRotationEvent:
    ...
    def __init__(self, last_action_success, scene_name, state=None, frame=None, objbb = None):
        self.metadata = {
...
class OfflineControllerWithSmallRotation(BaseController):
    ...
    def reset(self, scene_name=None):
        ...
        if scene_name != self.scene_name:
            ...
            if self.images_file_name == 'images.hdf5':
                self.images = self.h5py.File(
                    os.path.join(
                        '/home/Newdisk/lixinting/ECCV-VN-master-data/Data/AI2thor_offline_data_2.0.2/', self.scene_name, self.images_file_name
                    ),
                    "r",
                )
            else:
    ...
    def _successful_event(self):
        return OfflineControllerWithSmallRotationEvent(
            self.last_action_success, self.scene_name, self.state, self.get_image(), self.get_objbb()
        )
